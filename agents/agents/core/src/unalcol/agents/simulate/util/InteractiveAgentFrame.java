...
class InteractiveAgentFrame_jButton1_actionAdapter implements java.awt.event.ActionListener {
  InteractiveAgentFrame adaptee;

  InteractiveAgentFrame_jButton1_actionAdapter(InteractiveAgentFrame adaptee) {
